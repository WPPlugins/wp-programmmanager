...
if(isset($_POST['save_programm'])) {
    if($_POST['id'] != "") {
        ...
        $sql.= "', link='".$_POST['link']."', cat_id='".$_POST['cat'];
        ...
        global $wpdb;
        $sql ="INSERT INTO ".pmanagerMainTABLE." (name,description,installation,faq,download,link,cat_id) ";
        $sql.="VALUES ('".$_POST['name']."', '".$_POST['description']."', '".$_POST['installation']."'";
        $sql.=", '".$_POST['faq']."', '".$_POST['download']."', '".$_POST['link']."', '".$_POST['cat']."');";
        $query = $wpdb->query($sql);
    }
}
