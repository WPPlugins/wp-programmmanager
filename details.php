...
<div class="wrap">
    ...
    <table cellpadding="0" cellspacing="20" style="margin:auto;" class="widefat">
        ...
        <tr>
            <td colspan="7"><b>Path:</b></td>
            <td>$row->link</td>
        </tr>
        <tr>
            <td colspan="7"><b>Category:</b></td>
            <td>$category</td>
        </tr>
        <tr>
            <td colspan="7"><b>Download-Count:</b></td>
            <td>$row->count <form method="post"><input class="button-primary" type="submit" name="delete_count" value="Reset Count" /></form></td>
        </tr>
        <tr>
            <td colspan="7"><label><b>Description:</b></label></td>
            <td><label>$description</label></td>
        </tr>
        <tr>
            <td colspan="7"><label><b>Installation:</b></label></td>
            <td><label>$install</label></td>
        </tr>
        <tr>
            <td colspan="7"><label><b>FAQ:</b></label></td>
            <td><label>$faq</label></td>
        </tr>
        <tr>
            <td colspan="7"><label><b>Download:</b></label></td>
